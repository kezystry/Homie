...
**562 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (562 tests)
...
tests/       stdlib unittest suite (55 files, 562 tests)
