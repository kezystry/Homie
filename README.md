...
**505 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (505 tests)
...
tests/       stdlib unittest suite (49 files, 505 tests)
