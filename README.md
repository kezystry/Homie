...
[![tests](https://img.shields.io/badge/tests-612%20passing-brightgreen)](tests/)
...
**612 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (612 tests)
...
tests/       stdlib unittest suite (63 files, 612 tests)
