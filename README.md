...
python3 -m unittest discover -s tests   # the test suite (295 tests)
...
The reasoning-node spine runs and is tested (**225 stdlib tests**). Built and
...
tests/       stdlib unittest suite (295 passing)
