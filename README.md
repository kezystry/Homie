...
[![tests](https://img.shields.io/badge/tests-529%20passing-brightgreen)](tests/)
...
**529 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (529 tests)
...
tests/       stdlib unittest suite (52 files, 529 tests)
