...
**595 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (595 tests)
...
tests/       stdlib unittest suite (60 files, 595 tests)
