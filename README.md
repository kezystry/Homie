...
[![tests](https://img.shields.io/badge/tests-497%20passing-brightgreen)](tests/)
...
**497 stdlib tests pass** — and the tested graph *is* the shipped graph.
...
python3 -m unittest discover -s tests   # the full suite (497 tests)
...
tests/       stdlib unittest suite (48 files, 497 tests)
